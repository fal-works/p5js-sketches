...
import { Range } from "./common/dataTypes";
...
export const DATA_UNIT_LENGTH: Range = { start: 2, end: 15 };
export const DATA_UNIT_SHORT_INTERVAL: Range = { start: 3, end: 20 };
export const DATA_UNIT_LONG_INTERVAL: Range = { start: 40, end: 160 };
export const SHORT_INTERVAL_PROBABILITY = 0.8;

export const LINE_LENGTH: Range = { start: 20, end: 600 };
